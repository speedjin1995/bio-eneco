...
if (!empty($data)) {
    ...
    foreach ($data as $row) {
        ...
        $weighttype = !empty($row['weighttype']) ? $row['weighttype'] : "Normal";
        $customertype = !empty($row['customertype']) ? $row['customertype'] : "Normal";
        ...
        $exdel = !empty($row['exdel']) ? $row['exdel'] : "EX";
        ...
        $iscomplete = !empty($row['iscomplete']) ? $row['iscomplete'] : "N";
        $iscancel = !empty($row['iscancel']) ? $row['iscancel'] : "N";
        $isapproved = !empty($row['isapproved']) ? $row['isapproved'] : "Y";
        $manualweight = !empty($row['manualweight']) ? $row['manualweight'] : null;
        $indicatorid = !empty($row['indicatorid']) ? $row['indicatorid'] : 'X722';
        $weighbridgeid = !empty($row['weighbridgeid']) ? $row['weighbridgeid'] : '1';
        ...
        $totalprice = !empty($row['totalprice']) ? $row['totalprice'] : "0.00";
        $loaddrum = !empty($row['loaddrum']) ? $row['loaddrum'] : "LOAD";
        ...
        $synced = !empty($row['synced']) ? $row['synced'] : "N";
        $received = !empty($row['received']) ? $row['received'] : "Y";
