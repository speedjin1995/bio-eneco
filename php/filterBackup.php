...
## Search 
if ($role == 'NORMAL') {
  $searchQuery = " and created_by = '".$_SESSION["username"]."'";
}else{
  $searchQuery = " ";
}
...
$allQuery = "select count(*) as allcount from Weight where 1=1";
if($_SESSION["roles"] != 'ADMIN' && $_SESSION["roles"] != 'SADMIN'){
  $username = implode("', '", $_SESSION["plant"]);
  $allQuery = "select count(*) as allcount from Weight where 1=1 and plant_code IN ('$username')";
}
...
$filteredQuery = "select count(*) as allcount from Weight where 1=1".$searchQuery;
if($_SESSION["roles"] != 'ADMIN' && $_SESSION["roles"] != 'SADMIN'){
  $username = implode("', '", $_SESSION["plant"]);
  $filteredQuery = "select count(*) as allcount from Weight where 1=1 and plant_code IN ('$username')".$searchQuery;
}
...
## Fetch records
$empQuery = "select * from Weight where 1=1".$searchQuery."order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;

if($_SESSION["roles"] != 'ADMIN' && $_SESSION["roles"] != 'SADMIN'){
  $username = implode("', '", $_SESSION["plant"]);
  $empQuery = "select * from Weight where 1=1 and plant_code IN ('$username')".$searchQuery."order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
}
